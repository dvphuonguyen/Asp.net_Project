...
namespace FrameworkProject.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public MessagesController(ShopDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name,Subject,Email,Photo,Phone,Message1,ReadAt")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
